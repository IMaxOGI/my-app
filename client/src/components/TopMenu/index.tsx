        ...
        <nav className="navbar navbar-expand-lg bg-body-tertiary">
            <div className="container">
                <div>
                    ...
                    <a className="navbar-brand ps-2" href="#">Inventors</a>
                </div>
                <div className="collapse navbar-collapse ms-3">
                    ...
                    <div>
                        <p className="fs-6 text-start mb-2">Вторник</p>
                        <div className="d-flex">
                            <p className="fs-6 mb-2">{formattedTime}</p>
                            <p className="fs-6 ps-3 mb-2"><i className="bi bi-clock"></i> Active sessions: {activeSessions}</p>
                        </div>
                    </div>
                </div>
            </div>
